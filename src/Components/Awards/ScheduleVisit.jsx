...
const ScheduleVisit = () => {
    return (
        <div className="shadow-2xl rounded-3xl ">
            <div className='bg-white text-black overflow-hidden rounded-3xl flex justify-center md:flex-row flex-col transition-all duration-500'>

                <div className='md:w-1/2 p-8 space-y-8'>
                    <h1 className='text-5xl font-semibold font-outfit '>Schedule a visit</h1>
