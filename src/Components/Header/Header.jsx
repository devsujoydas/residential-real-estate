            ...
            <div className='container px-6 py-4 mx-auto'>
                <div className='lg:flex lg:items-center lg:justify-between'>
                    <div className='flex items-center justify-between'>
                        <Link to="/">
                            <img className="md:w-fit w-34" src="https://wordpress.themeholy.com/realar/wp-content/uploads/2024/04/logo-white2.svg" alt="Logo" />
                        </Link>
                    ...
                    >
                        <div>
                            <Nav isOpen={isOpen} user={user} setIsOpen={setIsOpen} />
                        </div>

                        <div className='flex items-center mt-4 lg:mt-0'>
                            <button
                                className='hidden mx-4 bg-primary transition-colors duration-300 transform lg:block dark:text-gray-200 hover:text-gray-500 dark:hover:text-gray-400 focus:text-gray-600 dark:focus:text-gray-400 focus:outline-none'
