...
const { featuredProperties } = useContext(AuthContext)
  ...
  return (
    <div className="relative">
      <img className="absolute md:block hidden md:h-fit h-20 left-5 md:left-10 md:top-10 top-2 aboutus-rotator" id="" src="https://wordpress.themeholy.com/realar/wp-content/uploads/2024/05/section_shape_2_1-1.png" alt="" />
      <img className="absolute md:block hidden md:h-fit h-20 md:right-10 right-2  md:bottom-10 bottom-2 aboutus-rotator" id="" src="https://wordpress.themeholy.com/realar/wp-content/uploads/2024/05/section_shape_2_1-1.png" alt="" />

      <div className="lg:py-25 py-10">
        {/* Section Heading  */}
        <div className="flex justify-center items-center flex-col space-y-5">
          <h1 className="  border-t border-b py-1">Best Project</h1>
          <h1 className=" md:text-5xl text-3xl font-semibold font-outfit">Ongoing Projects</h1>
